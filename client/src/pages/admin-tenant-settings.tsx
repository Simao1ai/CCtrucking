...
import { Building2, Palette, Settings, Users, Save, Loader2 } from "lucide-react";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                {form.accentColor && (
                  <div className="w-9 h-9 rounded-md border shrink-0" style={{ backgroundColor: form.accentColor }} />
                )}
              </div>
            </div>
            <div className="space-y-2">
